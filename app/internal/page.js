...
const resources = [
  ...
  },
  {
    ...
    name: 'Talent Pool',
    cat: 'Pipeline', catKey: 'pipeline',
    desc: 'Candidatos que entraron via /jobs y /referrals. Ver perfil completo, editar status, notas, tags y mandar edit link al candidato.',
    descShort: 'Candidatos del talent pool — status, notas, edit link.',
    glyph: 'TP',
    staticRank: 4.2, status: 'live',
    href: '/internal/talent-pool',
    adminOnly: true,
  },
  {
    id: 'job-subscribers',
    ...
    cat: 'Pipeline', catKey: 'pipeline',
    desc: 'Suscriptores del digest semanal del job board público. Lunes 10am ART. Vista de candidatos y recruiters.',
    descShort: 'Suscriptores del digest semanal del job board.',
    glyph: 'DS',
    staticRank: 4.4, status: 'live',
    href: '/internal/job-subscribers',
    adminOnly: true,
  },
  {
    id: 'lead-analyzer',
