  ...
  es: {
    ...
    audiences: [
      ...
      },
      {
        ...
        titleEm: 'Strategy',
        desc: 'Herramientas para hiring managers y fondos planeando su estrategia de contratación en LATAM. Intel de mercado, benchmarks y playbooks de calibración.',
        tools: ['Market Pulse', 'Benchmarks de comp.', 'Frameworks de calibración'],
        cta: 'Entrar →',
        href: '/hiring-strategy',
        status: 'live',
        statusLabel: 'Activo · Sin login',
      },
      {
        ...
        title: 'Busco Trabajo',
        titleEm: 'Trabajo',
        desc: 'Caja de herramientas para candidatos tech. Jobs nuevos a diario, búsquedas exclusivas de Bondy, talent pool y referidos.',
        tools: ['Jobs tech a diario', 'Búsquedas Bondy', 'Sumar tu perfil', 'Referidos'],
        cta: 'Entrar →',
        href: '/busco-trabajo',
        status: 'live',
        statusLabel: 'Activo · Sin login',
  ...
  en: {
    ...
    audiences: [
      ...
      },
      {
        ...
        title: 'Hiring Strategy',
        titleEm: 'Strategy',
        desc: 'Tools for hiring managers and funds planning their LATAM hiring strategy. Market intel, comp benchmarks and calibration playbooks.',
        tools: ['Market Pulse', 'Comp. benchmarks', 'Calibration frameworks'],
        cta: 'Enter →',
        href: '/hiring-strategy',
        status: 'live',
        statusLabel: 'Live · No login',
      },
      {
        ...
        title: 'Busco Trabajo',
        titleEm: 'Trabajo',
        desc: 'A toolbox for tech candidates. Fresh jobs daily, Bondy exclusive searches, talent pool and referrals.',
        tools: ['Daily tech jobs', 'Bondy searches', 'Join the pool', 'Referrals'],
        cta: 'Enter →',
        href: '/busco-trabajo',
        status: 'live',
        statusLabel: 'Live · No login',
        ...
        <section className="btl-hero">
          ...
          <h1 className="btl-hero__title">
            ...
            <span className="btl-hero__title-tools">
              <em>{c.titleEm}</em>
              <span className="btl-hero__under"><BondyUnderline width={220} /></span>
            </span>
          </h1>
