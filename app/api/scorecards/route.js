...
// GET /api/scorecards?client=IOL  → scorecard del cliente (o default)
// GET /api/scorecards              → lista de todas las scorecards activas
export async function GET(request) {
  try {
    ...
    if (client) {
      ...
      // Sin scorecard propia → devolver la default
