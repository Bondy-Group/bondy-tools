...
async function getAccessToken() {
  ...
  // Normalize private key — Vercel stores \n as literal backslash-n
  ...
  // Sign with RS256 — works for both PKCS8 (BEGIN PRIVATE KEY) and RSA (BEGIN RSA PRIVATE KEY)
  ...
  try {
    ...
    throw new Error(`JWT signing failed — GOOGLE_PRIVATE_KEY may be malformed. Details: ${signErr.message}`)
  }
