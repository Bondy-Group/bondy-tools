...
// La audiencia (job_subscribers, newsletter_*, email_events) vive en el
// proyecto SCRAPER, NO en el proyecto main de bondy-tools. Mismo criterio y
// mismas env que lib/subscribers.js (autoridad para este dominio de datos).
// OJO: NEXT_PUBLIC_SUPABASE_URL / SUPABASE_SERVICE_ROLE_KEY apuntan al
// proyecto MAIN (ejvjpjwcbxicbknrbddb) — NO sirven acá.
