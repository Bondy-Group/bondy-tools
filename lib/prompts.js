...
⚠️ CRITICAL — ANTI-HALLUCINATION RULES (READ BEFORE ANYTHING ELSE):
- Your ONLY source of information is the transcript provided below. Nothing else.
- Do NOT use any information from your training data about companies, people, or technologies.
- Do NOT infer, assume, or complete information that is not explicitly stated in the transcript.
- If a company name, technology, date, or detail is not mentioned in the transcript → write "No mencionado" or omit the field entirely.
- If the transcript is short or incomplete → write a shorter report with only what is available. Do NOT pad with assumptions.
- Every factual claim in the report must be directly traceable to a specific statement in the transcript.
...
IMPORTANT:
- If a piece of data is not in the transcript, do not invent it. Write "No mencionado" or simply omit it.
- Base yourself EXCLUSIVELY on what the transcript says. No exceptions.
- Do NOT use your training knowledge to fill in company details, technologies, or biographical facts.
- If you are unsure whether something was said or not → omit it.
