...
TASK: Read the full interview transcript and write a professional screening report in ENGLISH, ready to send to the hiring client.

${clientLine}

HOW TO READ THE TRANSCRIPT:
This is a real recruiter-candidate conversation, often informal. Information is NOT always stated as explicit facts — it emerges from the dialogue. You must read conversationally:
- The candidate's SALARY ACCEPTANCE: if the recruiter mentions a number ("they pay $3,500") and the candidate agrees ("yes, that works"), that IS the expected salary.
- MOTIVATION is revealed by which position the candidate chooses when offered options, and why.
- ACADEMIC BACKGROUND may appear as the candidate mentions their university, certifications, or courses in passing.
- WORK HISTORY is often discussed informally ("I left Amaris, then Mercedes called me") — piece together the timeline.
- CURRENT SITUATION: if the candidate says they have their own clients or freelance work, note that.

RULES:
- Write ONLY in English.
- Extract from the full transcript. If something is truly not discussed → write "Not mentioned".
- Do NOT write "Not mentioned" for things that ARE discussed informally in the conversation.
- Max 750 words. Dense and direct.
...
## Academic background
List degrees, certifications, or courses mentioned anywhere in the conversation. If truly nothing mentioned → omit this section.

## Experience in the role
2-3 sentences: what they built, led, or delivered. Not a timeline — focus on impact.

## Technical profile
- **Languages & frameworks:** [explicitly mentioned]
- **Databases:** [if mentioned]
- **Cloud / DevOps:** [if mentioned]
- **Architecture:** [if mentioned]
- **Other tools:** [if mentioned]
- **To validate:** [skills not confirmed in conversation — label as unconfirmed]
${jdSection}
...
2-3 sentences. READ THE FULL CONVERSATION for this:
- Did they choose between multiple positions offered? Which did they pick and explicitly why?
- What environment/culture do they want or want to avoid?
- What is their current situation and what are they seeking?

## Compensation & availability
- **Current situation:** [employed / freelance / unemployed — read from context, e.g. "I have my own clients"]
- **Current salary:** [if mentioned]
- **Expected salary:** [capture even indirect mentions — e.g. candidate agreeing to a number the recruiter proposes]
- **Key benefits:** [what they mention wanting: remote, specific culture, etc.]
- **Interview availability:** [only if explicitly stated — otherwise "Not mentioned"]
- **Start availability:** [only if explicitly stated — otherwise "Not mentioned"]

## Overall assessment
2-3 sentences: strengths, risks, fit. End with:
...
Este es una conversación real entre recruiter y candidato, frecuentemente informal. La información NO siempre aparece como un dato explícito — surge del diálogo. Tenés que leer conversacionalmente:
- SALARIO: si el recruiter menciona un número ("pagan $3.500") y el candidato acepta ("sí, está bien"), ESA es la pretensión/acuerdo salarial.
- MOTIVACIÓN: se revela cuando el candidato elige entre varias posiciones ofrecidas, y explica por qué.
- FORMACIÓN ACADÉMICA: puede aparecer cuando el candidato menciona su universidad, certificaciones o cursos de pasada.
- HISTORIAL LABORAL: se discute informalmente ("me fui de Amaris, después me llamó Mercedes") — armar el timeline con eso.
- SITUACIÓN ACTUAL: si el candidato dice que tiene clientes propios o trabajo freelance, capturarlo.

REGLAS:
- Escribí TODO en español. Los términos técnicos pueden quedar en inglés.
- Extraé del transcript completo. Si algo genuinamente no se discute → escribí "No mencionado".
- NO escribas "No mencionado" para cosas que SÍ se discuten informalmente en la conversación.
- Máximo 750 palabras. Denso y directo.
...
## Formación académica
Listá títulos, certificaciones o cursos mencionados en cualquier parte de la conversación. Si genuinamente no se menciona nada → omitir esta sección.

## Experiencia en la posición
2-3 oraciones: qué construyó, lideró o entregó. No una timeline — enfocate en el impacto.

## Perfil técnico
- **Lenguajes y frameworks:** [mencionados explícitamente]
- **Bases de datos:** [si se menciona]
- **Cloud / DevOps:** [si se menciona]
- **Arquitectura:** [si se menciona]
- **Otras herramientas:** [si se menciona]
- **A validar:** [skills no confirmados en la conversación — aclarar que no están confirmados]
${jdSection}
...
2-3 oraciones. LEÉ TODA LA CONVERSACIÓN para esto:
- ¿Eligió entre varias posiciones ofrecidas? ¿Cuál eligió y por qué, con sus propias palabras?
- ¿Qué ambiente/cultura busca o quiere evitar?
- ¿Cuál es su situación actual y qué está buscando?

## Compensación y disponibilidad
- **Situación actual:** [empleado / freelance / desempleado — leer del contexto, ej. "tengo mis propios clientes"]
- **Sueldo actual:** [si se menciona]
- **Pretensión salarial:** [capturar incluso menciones indirectas — ej. candidato aceptando un número que propone el recruiter]
- **Beneficios clave:** [qué menciona querer: remoto, cultura específica, etc.]
...
## Apreciación global
2-3 oraciones: fortalezas, riesgos, fit para este rol. Terminar con:
