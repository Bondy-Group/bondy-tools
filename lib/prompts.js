...
- Extract information ONLY from the transcript. Do not invent or assume anything.
- If something is not mentioned in the transcript → write "Not mentioned" or skip the field.
- A short, accurate report is always better than a long, padded one.
- Max 700 words total. Be dense and direct.

THE TRANSCRIPT IS A REAL INTERVIEW — it will contain the full conversation. Extract technical skills, experience, salary expectations, motivation, and availability from what the candidate says throughout the entire conversation.
...
**Links:** [LinkedIn / GitHub if mentioned]
---

## Experience in the role
2-3 sentences on relevant experience for this type of position. Focus on what they've built, led, or delivered — not a timeline.

## Technical profile
Extract from the full transcript. List by category:
...
- **To validate:** [skills not confirmed but likely based on role — be explicit these are unconfirmed]
${jdSection}

## Communication skills
2-3 sentences: clarity, structure, comfort level, bilingual ability if applicable.

## Languages
- [Language]: [Native / Bilingual / Advanced / Intermediate / Basic]

## Motivation for change
2-3 sentences: what is driving the change. What do they really want?

## Compensation & availability
- **Current situation:** [employed / freelance / unemployed]
- **Current salary:** [if shared]
- **Expected salary:** [amount + currency]
- **Key benefits:** [what matters most]
- **Interview availability:** [immediate / specific date]
- **Start availability:** [immediate / X weeks]

## Overall assessment
2-3 sentences: honest overall impression. Strengths, risks, fit. End with:
...
- Extraé información ÚNICAMENTE del transcript. No inventes ni asumas nada.
- Si algo no se menciona → escribí "No mencionado" u omití el campo.
- Un informe corto y preciso es siempre mejor que uno largo y relleno.
- Máximo 700 palabras totales. Sé denso y directo.

EL TRANSCRIPT ES UNA ENTREVISTA REAL — va a contener la conversación completa. Extraé skills técnicos, experiencia, pretensiones salariales, motivación y disponibilidad de lo que el candidato dice a lo largo de toda la conversación.

FORMATO DE SALIDA (usá exactamente estos headers):
...
**Links:** [LinkedIn / GitHub si se menciona]
---

## Experiencia en la posición
2-3 oraciones sobre experiencia relevante para este tipo de posición. Enfocate en qué construyó, lideró o entregó — no en una timeline.

## Perfil técnico
Extraé del transcript completo. Listá por categoría:
...
- **A validar:** [skills no confirmados pero probables por el rol — aclarar que son no confirmados]
${jdSection}

## Habilidades de comunicación
2-3 oraciones: claridad, estructura, nivel de comodidad, bilingüismo si aplica.

## Idiomas
- [Idioma]: [Nativo / Bilingüe / Avanzado / Intermedio / Básico]

## Motivación para el cambio
2-3 oraciones: qué lo está motivando. ¿Qué busca realmente?

## Compensación y disponibilidad
- **Situación actual:** [empleado / freelance / desempleado]
- **Sueldo actual:** [si lo compartió]
- **Pretensión salarial:** [monto + moneda]
- **Beneficios clave:** [qué le importa más]
- **Disponibilidad para entrevistas:** [inmediata / fecha específica]
- **Disponibilidad para empezar:** [inmediata / X semanas]

## Apreciación global
2-3 oraciones: impresión general honesta. Fortalezas, riesgos, fit. Terminar con:
