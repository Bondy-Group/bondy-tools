...
export async function saveInterviewToSupabase({ candidateName, candidateEmail, candidateAirtableId, reportType, reportContent, clientName, jobDescription, linkedinUrl, recruiterName, rawTranscript, scorecardId, scorecardData, language }) {
